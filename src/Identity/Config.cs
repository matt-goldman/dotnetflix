    ...
    public static IEnumerable<Client> Clients =>
        new Client[]
        {
            ...
            new Client
            {
                ...
                RedirectUris = { "https://localhost:5005/authentication/login-callback", "https://ambitious-meadow-0ec297a00.3.azurestaticapps.net/authentication/login-callback" },
                AllowedCorsOrigins = { "https://localhost:5005", "https://ambitious-meadow-0ec297a00.3.azurestaticapps.net" }
            },
